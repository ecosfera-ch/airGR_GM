CreateCalibOptions <- function(FUN_MOD,
  ...
  if (("HBAN"  %in% ObjectClass & is.null(StartParamList) & is.null(StartParamDistrib))) { # AK: TRUE 
    ...
    if ("CemaNeigeGR4J_Glacier" == FeatFUN_MOD$CodeMod) {
      ParamT <- matrix(c(+5.13, -1.60, +3.03, -9.05, -9.96, +6.63, +6.63, -9.96, +6.63,
                         +5.51, -0.61, +3.74, -8.51, -9.14, +6.90, +6.90, -9.14, +6.90,
                         +6.07, -0.02, +4.42, -8.06, +4.10, +7.21, +7.21, +4.10, +7.21), ncol = 9, byrow = TRUE)
    }
    ...
    if ("CemaNeigeGR6J_Glacier" == FeatFUN_MOD$CodeMod) {
      ParamT <- matrix(c(+3.60, -1.00, +3.30, -9.10, -0.90, +3.00, -9.96, +6.63, +6.63, -9.96, +6.63,
                         +3.90, -0.50, +4.10, -8.70, +0.10, +4.00, -9.14, +6.90, +6.90, -9.14, +6.90,
                         +4.50, +0.50, +5.00, -8.10, +1.10, +5.00, +4.10, +7.21, +7.21, +4.10, +7.21), ncol = 11, byrow = TRUE)
    }
