...
extern void F77_NAME(frun_glacier)(int *, double *, double *, double *, double *, double *, double *, double *);
...
static const R_FortranMethodDef FortranEntries[] = {
    ...
    {"frun_glacier",   (DL_FUNC) &F77_NAME(frun_glacier),    8},
    {NULL, NULL, 0}
};

void R_init_airGRalpine(DllInfo *dll)
{
